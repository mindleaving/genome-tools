...
namespace MoleculeViewer
{
    public class MoleculeViewModel
    {
        ...
        public MoleculeViewModel(Molecule molecule)
        {
            ...
            var lightSource = new DirectionalLight(Colors.White, new Vector3D(1, -1, 1));
            modelContent.Children.Add(lightSource);
            ...
            var position = new Point3D(moleculeCenter.X, moleculeCenter.Y + 100, moleculeCenter.Z - 300);
            var lookDirection = new Vector3D(moleculeCenter.X - position.X, moleculeCenter.Y - position.Y, moleculeCenter.Z - position.Z);
        ...
        private Color DetermineAtomColor(ElementName atomElement)
        {
            switch (atomElement)
            {
